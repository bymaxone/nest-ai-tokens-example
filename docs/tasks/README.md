...
| 08    | `phase-08-dashboard-pages.md`             | 6 / 6 | ✅     | the eight dashboard pages                                                                                              |
| 09    | `phase-09-quality-docs-audit.md`          | 4 / 6 | 🔄     | 100% coverage, full E2E, export audit, README, CI finalization                                                         |
